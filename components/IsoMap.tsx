...
// Fix: Correctly augment the JSX namespace for React Three Fiber elements.
// Using declare global to extend the React.JSX namespace, ensuring intrinsic elements like 'mesh'
// are recognized without shadowing standard HTML elements in other files.
declare global {
  namespace React {
    namespace JSX {
